                    ...
                    <div class="row">
                        <div class="col-xl-12 text-center text-info alert alert-primary">
                            <p>
                                ...
                                Alternatively, you can scan the Barcode below to get the wallet address:<br/>
                                <img class="mt-4 mb-4" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{$investment->wallet}}">
                            </p>
                            <button class="btn btn-primary btn-clipboard" data-clipboard-target="#address">Copy</button>
                        </div>
                    </div>
{{--                    <div class="row">--}}
{{--                        <div class="col-md-12">--}}
{{--                            <div class=" text-center">--}}
{{--                                <a href="{{route('invest.cancel',['id'=>$investment->id])}}" class="btn btn-danger">Cancel</a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                </div>
