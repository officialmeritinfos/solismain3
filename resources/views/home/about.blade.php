            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_13">
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p>{{$siteName}} is a professional wealth management company with emphasis on Wealth Creation
                                    ...
                                    {{$siteName}} has qualified and licensed financiers that manages and provides financial consulting services for her investors.
                                    ...
                                    Any fund you invest with {{$siteName}} is yours and you are free to withdraw your total balance whenever you wish as signed
                                    ...
                                    Business Enterprise portfolio and in return provides insurance services and elite attorneys for {{$siteName}}.</p>
                            </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_four">
                        <div class="image-box">
                            <div class="pattern-layer" style="background-image: url({{asset('home/images/shape/shape-23.jpg')}});"></div>
