        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('admin/coins')}}">Wallets</a>
                    <a class="collapse-item" href="{{url('admin/settings')}}">Account Settings</a>
                    @if($user->is_admin ==1)
                        <a class="collapse-item" href="{{url('account/dashboard')}}">Investor Section</a>
                    @endif
                </div>
            </div>
        </li>
